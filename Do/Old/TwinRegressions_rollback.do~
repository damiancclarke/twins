...
if `"`pooled'"'=="yes" {
        ...
        foreach inc in `allinc' `lowinc' `midinc' {
                ...
                local basecontrols malec i.age agemay magesq i._cou i.year_birth 
                local morecontrols height bmi educf_1_4 educf_5_6 educf_7_10 educf_11plus poor1
                local baseoutregvars malec agemay magesq 
                local moreoutregvars malec agemay magesq `morecontrols'
