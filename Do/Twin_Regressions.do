...
if `"`sumstats'"'=="yes" {
	...
	*(1a) Total births by Family Type (for families who exceed desired fertility)
	...
	graph export "$Results/Graphs/famsize_exceed.`format'", as(`format') replace
	...
	*(2) Twins by bord
	...
	graph export "$Results/Graphs/twinbybord.`format'", as(`format') replace
	restore
	...
	*(3) Desired family size
	...
	graph export "$Results/Graphs/idealfamsize.`format'", as(`format') replace	
	restore
