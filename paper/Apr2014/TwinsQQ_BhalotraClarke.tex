...
\label{TWINsscn:samples}
\input{./Samples.tex}

\subsection{Descriptive Statistics}
\input{./Descriptives.tex}
...
\label{TWINsscn:methodQQ}
\input{./Methodology/QQ.tex}
\subsection{Bounding the Q-Q Trade-off}
\label{TWINsscn:methodBounds}
\input{./Methodology/BoundEst.tex}



\section{Results}
\label{TWINscn:results}
\input{./Results.tex}
