...
our estimate of $\gamma$ in \citeauthor{Conleyetal2012}'s bound estimator.
...
In panel B of table \ref{TWINtab:Conley} we provide estimates of Conley
bounds using our estimated $\gamma$.  These are our preferred bounds estimates
for $\beta_1$.  As described in appendix \ref{TWINscn:gamma}, for the UCI
approach this implies an assumption that $\gamma \in [0,2\hat\gamma]$.  For
the LTZ approach, we assume that $\gamma\sim N(\mu_{\hat\gamma},\sigma_{\hat\gamma})$.
The assumption of normality is driven by...
