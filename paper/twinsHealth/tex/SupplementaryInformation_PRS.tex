...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.9]{./forest/forestCrop_Cond}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.9]{./forest/forestCrop_ART}
  \end{center}
