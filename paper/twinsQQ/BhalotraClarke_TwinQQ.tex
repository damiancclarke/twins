...
\texttt{Section 5.3 has been re-drafted up to this point. Pick it up here.}
...
\texttt{Section 5.4 has been re-drafted up to this point. Pick it up here.}
...
of different distributions is not rejected with a $p$-value of 0.1805.%
\footnote{In all cases tested (uniform, normal, log normal, $\chi^2$),
...
the p-value is much lower, at 0.1019.}  The 
