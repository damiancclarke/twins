...
reg attendance fert malec agemay age6-age16 yearc1-yearc88 country1-country46 /*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel replace
reg attendance fert malec agemay age6-age16 educfyrs educfyrs_sq height bmi poor1 yearc1-yearc88 country1-country46 /*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twind) malec agemay age6-age16 yearc1-yearc88 country1-country46/*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twind) malec agemay age6-age16 educfyrs educfyrs_sq height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>5 & age<17 
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twind) malec agemay age6-age16 educmale1- educmale6 educfyrs1- educfyrs28 height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>5 & age<17 
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
...
*/borddummy2 borddummy3 borddummy4  borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twin_`x'_fam) malec agemay age6-age16 yearc1-yearc88 /*
*/country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twin_`x'_fam) malec agemay age6-age16 educfyrs educfyrs_sq height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
ivreg2 attendance (fert=twin_`x'_fam) malec agemay age6-age16 educmale1- educmale6 educfyrs1- educfyrs28 height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\Attendance1.xls, excel append
}
...
reg eduyears fert malec agemay age17-age38 yearc1-yearc88 country1-country46 /*
*/ if age>16
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel replace
reg eduyears fert malec agemay age17-age38 educfyrs educfyrs_sq height bmi poor1 yearc1-yearc88 country1-country46 /*
*/ if age>16
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twind) malec agemay age17-age38 yearc1-yearc88 country1-country46/*
*/ if age>16
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twind) malec agemay age17-age38 educfyrs educfyrs_sq height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>16
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twind) malec agemay age17-age38 educmale1- educmale6 educfyrs1- educfyrs28 height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>16
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
...
*/ borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>16 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twin_`x'_fam) malec agemay age17-age38 yearc1-yearc88 /*
*/country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>16 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twin_`x'_fam) malec agemay age17-age38 educfyrs educfyrs_sq height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>16 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
ivreg2 eduyears (fert=twin_`x'_fam) malec agemay age17-age38 educmale1- educmale6 educfyrs1- educfyrs28 height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>16 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\Eduyears1.xls, excel append
}
...
*THESE FOLLOWING THREE LINES ARE NICE, BUT VERY SIMPLE (Good story)
reg gap fert malec agemay age6-age16 yearc1-yearc88 country1-country46 /*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel replace
reg gap fert malec agemay age6-age16 yearc1-yearc88 country1-country46 /*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twind) malec agemay age6-age16 educfyrs educfyrs_sq height bmi poor1 yearc1-yearc88 country1-country46/*
*/ if age>5 & age<17
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twind) malec agemay age6-age16 educfyrs educfyrs_sq height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>5 & age<17 
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twind) malec agemay age6-age16 educmale1- educmale6 educfyrs1- educfyrs28 height bmi poor1 /*
*/ yearc1-yearc88 country1-country46 if age>5 & age<17 
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
...
*/ borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
reg gap fert malec agemay age6-age16 educfyrs educfyrs_sq height bmi poor1 yearc1-yearc88 country1-country46 /*
*/ borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twin_`x'_fam) malec agemay age6-age16 yearc1-yearc88 /*
*/country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twin_`x'_fam) malec agemay age6-age16 educfyrs educfyrs_sq height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
ivreg2 gap (fert=twin_`x'_fam) malec agemay age6-age16 educmale1- educmale6 educfyrs1- educfyrs28 height /*
*/bmi poor1 yearc1-yearc88 country1-country46 borddummy2 borddummy3 borddummy4 borddummy5 borddummy6 if age>5 & age<17 & `x'_plus==1 
outreg2 using $Base\Results\Outreg\Attendance\gap1.xls, excel append
}


do $Base\Do\20120409_TwinIV_control
