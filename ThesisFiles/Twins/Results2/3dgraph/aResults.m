...
set(gca,'YTickLabel',{' ', 'Low Income     ', 'Lower Middle     ', 'Upper Middle    '})
set(gca,'XTickLabel',{'OLS No Control     ', 'OLS Socioeconomic     ', 'OLS Health    ', 'IV No Control     ', 'IV Socioeconomic     ', 'IV Health    ', ' '})
xlabel('Estimator');
ylabel('Country Group');
zlabel('\Beta_{Fertility}');
grid on
%axis square
axis xy
%L = legend('\beta<-0.5', '-0.5<\beta<-0.25', '-0.25<\beta<-0', '\beta>0', location, 'NorthEastOutside');
