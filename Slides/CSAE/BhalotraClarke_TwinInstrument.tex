...
\begin{enumerate}
\item Twin births \emph{are not} exogenous
\item Taking twins to term depends on health stocks and behaviours of mothers during pregnancy
\item This is a widespread (unrecognised) phenomenon in rich and poor countries
\item This results in inconsistent estimates of the Q-Q trade-off
\item Our revised estimates (Developing countries and USA) suggest that this may help to explain the insignificant findings in the literature
\end{enumerate}
}
...
\begin{itemize}
 \item \hyperlink{Macro}{\textcolor{blue}{Ample evidence}} from cross-sectional data within and across regions suggests that children from larger families have weaker educational outcomes, e.g. Hanushek 1992, Blake 1989.
...
Examine whether women who have twins are healthier before twins or twin conception has occurred:
\vspace{2mm}
